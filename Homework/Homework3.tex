      ...
      \item Calculate 
        ...
        \begin{enumerate}
          ...
          \item the electrostatic energy of the trapped positrons and
            ...
            We can find the energy in the following way:

            $$U=\frac{1}{2}\int_r^\infty\varepsilon_oE^2\,d\tau$$

            We then break off the area term of $\tau$:

            $$U=\frac{1}{2}\int_r^\infty\varepsilon_o\left( \frac{Q}{4\pi\varepsilon_o r^2} \right)^2(4\pi r^2)\,dr$$
            $$U=\frac{Q^2}{8\pi\varepsilon_o}\int_r^\infty \frac{1}{r^2}\,dr$$
            $$U=\frac{Q^2}{8\pi\varepsilon_o}\left( -\frac{1}{r} \right)\Big|_r^\infty$$
            $$U=\frac{Q^2}{8\pi\varepsilon_or}$$

            We then substitute the values we know:

            $$U=\frac{\left(  .1758\right)^2}{4\pi\varepsilon_o(.001)}$$
            $$\boxed{U=1.3895\cdot10^{11}[\si{\joule}]}$$

          \item the energy that would be released by antimatter annihilation (twice the rest energy of the positrons)

            This would produce twice the rest energy of the positrons. This can be calculated using:

            $$E=2m_ec^2$$
            $$=2(9.1\cdot10^{-31})(3\cdot10^{8})^2$$
            $$=1.638\cdot10^{-13}[\si{\joule}]$$
            $$\boxed{=1.022[\si{\mega\eV}]}$$

            This makes sense, as it is twice the rest mass of electrons.
